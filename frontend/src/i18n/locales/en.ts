  ...
  printers: {
    ...
    toast: {
      ...
      forceAddWarning: {
        ...
        description: 'This printer failed the connection diagnostic. It may be due to one of the following reasons:',
        reasonOffline: 'Printer is offline and not responding to requests',
        reasonInvalidData: 'Incorrect data entered: IP address, serial number, or Access Code',
        reasonNotLANMode: 'Printer is not set to LAN mode',
        warning: 'Once added, the printer will appear as UNAVAILABLE in your printer list and will not be able to connect. You will not be able to interact with it until you correct the settings or the printer becomes accessible.',
        confirmation: 'I understand that the printer may not connect and will be marked as unavailable',
        goBack: 'Go back to data entry',
        cancel: 'Cancel',
        add: 'Add anyway',
      },
    },
    ...
    // Printer locations management
    locations: {
      title: 'Printer Locations',
      subtitle: '{{grouped}} grouped, {{ungrouped}} ungrouped',
      create: 'New Location',
      ...
      group_few: '{{count}} groups',
      group_many: '{{count}} groups',
      // Group management actions
      showEmpty: 'Show empty',
      hideEmpty: 'Hide empty',
      selectGroups: 'Select',
      selectGroupsActive: 'Done',
      ...
      edit: 'Edit',
      noPrinters: 'No printers in this location',
      selectPrinter: 'Select printer',
      move: 'Move to another location',
      removeFromGroup: 'Remove from group',
      ungroupedPrinters: 'Ungrouped Printers',
      selected: '{{count}} selected',
      selected_one: '{{count}} selected',
      selected_few: '{{count}} selected',
      selected_many: '{{count}} selected',
      moveSelected: 'Move',
      deleteSelectedGroups: 'Delete selected',
      moveSelectedTitle: 'Move Printers',
      moveSelectedCount: '{{count}} printers',
      moveSelectedCount_one: '{{count}} printer',
      moveSelectedCount_few: '{{count}} printers',
      moveSelectedCount_many: '{{count}} printers',
      selectLocation: 'Select a location...',
      editIcon: 'Icon',
      editColor: 'Color',
      deleteSelectedGroupsTitle: 'Delete Selected Groups',
      deleteSelectedGroupsDescription: 'Are you sure? This will remove {{count}} group(s) and ungroup all printers in them.',
      deleteSelectedGroupsDescription_one: 'Are you sure? This will remove {{count}} group and ungroup all printers in it.',
      deleteSelectedGroupsDescription_few: 'Are you sure? This will remove {{count}} groups and ungroup all printers in them.',
      deleteSelectedGroupsDescription_many: 'Are you sure? This will remove {{count}} groups and ungroup all printers in them.',
      deleteDescription: 'Are you sure? This will remove this location from {{count}} printer(s).',
      deleteDescription_one: 'Are you sure? This will remove this location from {{count}} printer.',
      deleteDescription_few: 'Are you sure? This will remove this location from {{count}} printers.',
      deleteDescription_many: 'Are you sure? This will remove this location from {{count}} printers.',
      editTitle: 'Edit Location',
      editNamePlaceholder: 'Location name',
      moveTo: 'Move Printer',
      movePrinterName: '{{printer}}',
      // Mutation toast messages
      removedFromGroup: 'Printer removed from group',
      removeFromGroupError: 'Failed to remove printer from group',
      editSaved: 'Location updated',
      editSave: 'Save',
      editError: 'Failed to update location',
      moved: 'Printer moved',
      moveError: 'Failed to move printer',
      bulkMoved: '{{count}} printers moved',
      bulkMoved_one: '{{count}} printer moved',
      bulkMoved_few: '{{count}} printers moved',
      bulkMoved_many: '{{count}} printers moved',
      bulkMoveError: 'Failed to move printers',
      groupsDeleted: '{{count}} group(s) deleted',
      groupsDeleted_one: '{{count}} group deleted',
      groupsDeleted_few: '{{count}} groups deleted',
      groupsDeleted_many: '{{count}} groups deleted',
      deleteGroupsError: 'Failed to delete groups',
    },
  },
